...
mmlu_sample = random.sample(mmlu_entries, min(25, len(mmlu_entries)))
arc_sample = random.sample(arc_entries, min(25, len(arc_entries)))
...
final_dataset.push_to_hub("atreydesai/mmlu_arc_categories")